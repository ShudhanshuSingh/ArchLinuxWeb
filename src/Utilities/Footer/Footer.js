        ...
        <div className="md:max-w-md lg:col-span-2">
          ...
          <div className="mt-4 lg:max-w-sm">
            <p className="text-sm text-gray-800">
              Welcome to Arch Linux GUI. A fast, offline graphical installer for
              Vanilla Arch Linux!
            </p>
            <p className="mt-4 text-sm text-gray-800">
              The ALG project provides you with 12 editions, featuring Plasma 5,
              Gnome 40, Xfce4, Cinnamon 5, MATE desktops, i3WM and BSPWM. All
              editions come with a graphical installer.
            </p>
          </div>
        </div>
          ...
          <div>
            ...
            {currentLocation === "/" ? (
              <ul className="mt-2 space-y-2">
                ...
                <li>
                  <Link to="stats" spy={true} smooth={true}>
                    <button className="text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">
                      Stats
                    </button>
                  </Link>
            ...
            ) : currentLocation === "/tutorials" || currentLocation ==="/changelog" ? (
              <ul className="mt-2 space-y-2">
                <li>
                  <a
      ...
      <div className="flex flex-col justify-between pt-5 pb-10 border-t sm:flex-row">
        ...
        <div className="flex items-center mt-4 space-x-4 sm:mt-0">
          ...
          >
            ...
            <img
              src="https://img.icons8.com/fluency/48/000000/discord-logo.png"
              className="h-6"
            />
          </a>
          <a
